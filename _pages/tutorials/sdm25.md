...
<img src="{{ site.url }}{{ site.baseurl }}/images/Yu Wang.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
...
<img src="{{ site.url }}{{ site.baseurl }}/images/Haoyu Han.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;"/>
...
<br>
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/Harry Shomer.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
...
<br>
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/Kai Guo.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
...
<br>
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/Yongjia Lei.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
...
<br>
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/Jiayuan Ding.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
...
<br>
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/Xianfeng Tang.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
...
<br>
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/Jiliang Tang.png" class="img-responsive" width="10%" style="float: left; margin-right: 15px; margin-bottom: 10px;" />
